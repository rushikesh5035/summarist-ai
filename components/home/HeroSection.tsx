...
const HeroSection = () => {
  return (
    ...
    >
      ...
      <MotionH1 className="font-bold py-6 mt-4 text-center">
        Transform PDFs into{" "}
        <span className="relative inline-block">
          <MotionSpan whileHover={buttonVarient} className="relative z-10 px-2">
            concise
          </MotionSpan>
          <span
            className="absolute inset-0 bg-rose-200/50 -rotate-2 rounded-xl transform -skew-y-1"
            aria-hidden="true"
          ></span>
        </span>{" "}
        summaries
