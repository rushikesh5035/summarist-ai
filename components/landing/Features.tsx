...
const Features = () => {
  return (
    ...
    >
      ...
      <div className="max-w-screen-xl mx-auto px-6 md:px-10 lg:px-16 relative z-10">
        <motion.div
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
          <motion.div
            ...
            className="md:col-span-7 bg-gradient-to-br from-[#111] to-[#0d0d0d] rounded-2xl p-8 border border-gray-800/60 relative overflow-hidden group"
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-12 h-12 rounded-xl bg-[#0CF2A0]/10 border border-[#0CF2A0]/20 flex items-center justify-center flex-shrink-0">
          ...
          <motion.div
            ...
            className="md:col-span-5 bg-gradient-to-br from-[#111] to-[#0d0d0d] rounded-2xl p-8 border border-gray-800/60 relative overflow-hidden group"
          >
          ...
          >
            ...
            <div className="w-10 h-10 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center flex-shrink-0 relative z-10">
          ...
          >
            ...
            <div className="w-10 h-10 rounded-xl bg-rose-500/10 border border-rose-500/20 flex items-center justify-center flex-shrink-0 relative z-10">
